    ...
    const files = fs
      ...
      .map((file) => {
        ...
        return {
          ...
          downloadUrl: `${publicBaseUrl}/force-download/${encodeURIComponent(
            file
          )}`,
          viewUrl: `${publicBaseUrl}/downloads/${encodeURIComponent(file)}`,
        };
      })
            ...
            <ul class="file-list">
              ${files
                ...
                <li class="file-item">
                  ...
                  <a href="${file.viewUrl}" class="btn view-btn">👁️ Просмотр</a>
                </li>
              `
                )
                .join("")}
...
// Маршрут для просмотра/скачивания файлов
app.get("/downloads/:filename", (req, res) => {
  ...
  // Заголовки для просмотра/скачивания
